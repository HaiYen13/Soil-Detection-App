...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                MODEL_MOBILENETV1 -> "soil_cnn.tflite"
                MODEL_EFFICIENTNETV0 -> "soil_cnn.tflite"
                MODEL_EFFICIENTNETV1 -> "soil_cnn.tflite"
                MODEL_EFFICIENTNETV2 -> "soil_cnn.tflite"
                else -> "soil_cnn.tflite"
            }
